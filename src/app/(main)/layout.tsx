...
export default async function MainLayout({
  ...
  const [incoming, unreadMessages, unreadNotifications] = await Promise.all([
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Контент: сайдбар (десктоп) + основная колонка */}
      <div className="mx-auto flex max-w-5xl gap-6 px-3 py-4 sm:px-4 sm:py-6">
